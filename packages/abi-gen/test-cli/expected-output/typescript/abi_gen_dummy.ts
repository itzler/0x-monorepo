...
export class AbiGenDummyContract extends BaseContract {
    ...
    public nestedStructOutput = {
        async callAsync(
            callData: Partial<CallData> = {},
            defaultBlock?: BlockParam,
        ): Promise<{innerStruct: {someBytes: string;anInteger: number;aDynamicArrayOfBytes: string[];aString: string};description: string}
        > {
            assert.doesConformToSchema('callData', callData, schemas.callDataSchema, [
                schemas.addressSchema,
                schemas.numberSchema,
            ...
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<{innerStruct: {someBytes: string;anInteger: number;aDynamicArrayOfBytes: string[];aString: string};description: string}
        >(rawCallResult);
            // tslint:enable boolean-naming
            return result;
        },
    ...
    public structInput = {
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as AbiGenDummyContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('structInput((bytes,uint32,bytes[],string))', [s
        ]);
            return abiEncodedTransactionData;
        },
    };
    ...
    public nestedStructInput = {
        async callAsync(
            n: {innerStruct: {someBytes: string;anInteger: number|BigNumber;aDynamicArrayOfBytes: string[];aString: string};description: string},
            callData: Partial<CallData> = {},
            defaultBlock?: BlockParam,
        ): Promise<void
        > {
            ...
            const self = this as any as AbiGenDummyContract;
            const encodedData = self._strictEncodeArguments('nestedStructInput(((bytes,uint32,bytes[],string),string))', [n
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as AbiGenDummyContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('nestedStructInput(((bytes,uint32,bytes[],string),string))', [n
        ]);
            return abiEncodedTransactionData;
        },
    };
    public structOutput = {
        ...
        > {
            ...
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<{someBytes: string;anInteger: number;aDynamicArrayOfBytes: string[];aString: string}
        >(rawCallResult);
            // tslint:enable boolean-naming
            return result;
        },
